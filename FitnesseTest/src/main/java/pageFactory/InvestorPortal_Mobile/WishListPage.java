...
public class WishListPage 
{
	 ...
	 */ 	
			...
			/*@FindBy(xpath="")
			public WebElement NoPropertiesInWatchList; */
			...
			{
				WatchListTab.sendKeys(Keys.RETURN);;
			}
			...
			{
				//String cssSelector = "#wl_table tbody tr:nth-of-type(" + row + ") td:nth-of-type(2) i.fa fa-star removeWL fa--lg hu-green";
				String xpath= "//table[@id='wl_table']/tbody/tr/td[2]/span/i";
			...
			public void Wishlist_RemoveALLItem() throws InterruptedException
			{
				...
				for(int k=0;k<1000;k++)
				{
					try{
					    ...
					    if(GetTableData(1, 1).contains("There are no properties in your Watch List."))
						//if(SeleniumFunc.IsElementPresent(propertydetails.NeighborhoodTab_Section))
						{
							...
							System.out.println(GetTotalPropertiesCount());
						{
							try {
