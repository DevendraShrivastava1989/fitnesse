...
public class ViewPropertiesPage 
{
	...
	public ViewPropertiesPage(WebDriver driver)
	{	 
        this.driver = driver;
	 ...
	 */ 	
		...
		//Get Property Id
		public String GetPropertyId(int row)
		{
			String cssSelector = "table#datatable_ajax tr:nth-of-type(" + row + ") td:nth-of-type(18) a"; //karthik
			return driver.findElement(By.cssSelector(cssSelector)).getAttribute("title").trim();
		}
